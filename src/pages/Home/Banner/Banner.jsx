    ...
    return (
        <section className="bg-secondary">
            <div className="my-container min-h-[calc(100vh-96px)] text-left flex flex-col justify-center text-white space-y-4">
                ...
                <h1 className="text-3xl md:5xl lg:7xl font-bold">MD. Saiful Islam</h1>

                <h2 className="text-2xl md:text-4xl lg:text-6xl font-semibold text-neutral">I love to know the unknown.</h2>
